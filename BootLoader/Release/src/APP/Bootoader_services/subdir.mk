...
C_SRCS += \
../src/APP/Bootoader_services/Bootloader_services.c 

OBJS += \
./src/APP/Bootoader_services/Bootloader_services.o 

C_DEPS += \
./src/APP/Bootoader_services/Bootloader_services.d 


# Each subdirectory must supply rules for building sources it contributes
src/APP/Bootoader_services/%.o: ../src/APP/Bootoader_services/%.c
	@echo 'Building file: $<'
